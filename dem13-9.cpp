...
//This program demonstrates the correct use of destructors
...
class Trapezoid : public Shape
{
  ...
  public:
	 ...
	 virtual ~Trapezoid() {cout << "Trapezoid Destructor";}
...
int main()
{
  ...
  cout << "\n\nArea() for the " << s_p1 -> Get_Type()
       << " applied through Shape pointer: " << s_p1 -> Area();
