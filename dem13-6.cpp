...
//This program demonstrates the use of pointers and functions
...
int main()
{
  ...
  s_p1 = &c1;		//Shape pointer points to a Circle object

  c_p1 = &c1;		//Circle pointer points to a Circle object
